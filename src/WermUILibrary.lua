...
local ConfigurationExtension = ".werm"
...
local WermUILibrary = {
	...
	Theme = {
		Default = {
			TextFont = "Default", -- Default will use the various font faces used across WermUI
		...
		Light = {
			TextFont = "Gotham", -- Default will use the various font faces used across WermUI
...
function WermUILibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "WermUI Interface Suite"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "by Sirius"
	if Settings.LoadingTitle ~= "WermUI Interface Suite" then
		LoadingFrame.Version.Text = "WermUI UI"
	end
